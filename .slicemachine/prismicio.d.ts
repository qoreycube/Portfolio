 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ProjectPageDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<Simplify<ProjectPageDocumentData>, "project_page", Lang>;
...
export type AllDocumentTypes = NavigationDocument | PageDocument | ProjectPageDocument | SettingsDocument;
/**
...
interface ProjectSliceDefaultPrimary {
    /**
     * Title field in *ProjectList → Primary*
     *
     * - **Field Type**: Title
...
/**
 * Item in ProjectList → Items
 *
 */
export interface ProjectSliceDefaultItem {
    /**
     * Title field in *ProjectList → Items*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
    ...
    description: prismicT.RichTextField;
    /**
     * Image field in *ProjectList → Items*
     *
     * - **Field Type**: Image
     * - **Placeholder**: *None*
    ...
    image: prismicT.ImageField<never>;
    /**
     * External Link field in *ProjectList → Items*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: project.items[].external_link
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    external_link: prismicT.LinkField;
    /**
     * External Link CTA field in *ProjectList → Items*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: project.items[].external_link_cta
     * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
     *
     */
    external_link_cta: prismicT.KeyTextField;
    /**
     * Internal Link field in *ProjectList → Items*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: project.items[].internal_link
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    internal_link: prismicT.LinkField;
    /**
     * Internal Link CTA field in *ProjectList → Items*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: project.items[].internal_link_cta
     * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
     *
     */
    internal_link_cta: prismicT.KeyTextField;
}
/**
...
/**
 * Primary content in RelatedTechnologies → Primary
 *
 */
interface RelatedTechnologiesSliceDefaultPrimary {
    /**
     * Title field in *RelatedTechnologies → Primary*
     *
     * - **Field Type**: Title
     * - **Placeholder**: This is where it all begins...
     * - **API ID Path**: related_technologies.primary.title
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    title: prismicT.TitleField;
    /**
     * Description field in *RelatedTechnologies → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: related_technologies.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
...
/**
 * Default variation for RelatedTechnologies Slice
 *
 * - **API ID**: `default`
 * - **Description**: `RelatedTechnologies`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type RelatedTechnologiesSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<RelatedTechnologiesSliceDefaultPrimary>, never>;
/**
 * Slice variation for *RelatedTechnologies*
 *
 */
type RelatedTechnologiesSliceVariation = RelatedTechnologiesSliceDefault;
/**
 * RelatedTechnologies Shared Slice
 *
 * - **API ID**: `related_technologies`
 * - **Description**: `RelatedTechnologies`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
